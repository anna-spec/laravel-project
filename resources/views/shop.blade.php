    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 ">
            <div class="text-center text-white">
                <h1 class="display-6 fw-bolder">Shop in style</h1>
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    ...
                                    <div class="preview-meta">
                                        <ul>
                                            <li>
                                                <a href=""><img width="23px"
                                                                src="{{asset('images/icons8-link-24.png')}}" alt=""></a>
                                            </li>
                                            <li>
                                                <a href="{{url('customer/add-to-basket/'.$product->id)}}"><img
                                                        width="23px"
                                                        src="{{asset('images/icons8-shopping-cart-24.png')}}"
                                                        alt=""></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-content">
                                    <h4><a class="text-decoration-none"
                                           href="product-single.html">{{$product->title}}</a></h4>
