...
class AuthController extends Controller
{
    ...
    public function submitRegisterForm(Request $request)
    {
        ...
        if ($res){
            ...
            return back()->with('Registration faild');
        }
    ...
    public function submitLoginForm(Request $request)
    {
      ...
      $cridentials = $request->only(['email', 'password', 'role']);
        ...
        if(Auth::attempt($cridentials))
        {
            ...
            return Redirect::back()->withErrors(['msg' => 'the password or username is incorrect']);
        }
    }
